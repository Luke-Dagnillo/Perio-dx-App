...
requirements = python3,kivy,opencv_extras,opencv,numpy,firebase_admin,kivymd,requests,google.auth,pyasn1_modules,pyasn1,rsa,cachetools,cachecontrol,msgpack-python,pillow

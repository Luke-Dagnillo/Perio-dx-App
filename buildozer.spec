...
requirements = python3,kivy,opencv_extras,opencv,numpy,requests,firebase_admin,kivymd,requests,google.auth,pyasn1_modules,pyasn1,rsa,cachetools,cachecontrol,msgpack-python
...
icon.filename = %(source.dir)s/graphics/Perio-dx app icon.png
